  ...
  useEffect(() => {
    if(container!==undefined) {
      if(container === "container") {
        ...
        setLocalContainer("container--"+container);
      }
      
    }
  }, [])  
  return(
    <section className={"section__container "+ localContainer  + " " + cssClass}>      
      <div className="section__content relative">
        ...
        <div className={styles.config + " border p-1 align-items-center child-mr-2 " + (config ? "inline-flex" : "hidden")}>
          <select onChange={e=>setLocalContainer(e.currentTarget.value)}>
