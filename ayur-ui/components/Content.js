...
const ContentCustom = ({size,cssClass,weight,children, edit}) => { 
  ...
  return( 
    <div className="relative">
      ...
      <div className={"font-" + localSize + " weight-" + localWeight+" " + (cssClass ?? "")}>{children}
        {edit &&
        <span onClick={e => setConfig(!config)} className={styles.config__heading + " ico"}><svg
